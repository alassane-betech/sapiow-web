import { useGetFavorites, useAddFavorite, useRemoveFavorite } from "@/api/favorites/useFavorites";
...
export const useFavoritesLogic = () => {
  ...
  const { data: favoritesData, isLoading: isLoadingFavorites } = useGetFavorites();
  ...
  return {
    ...
    isMutatingFavorite: addFavoriteMutation.isPending || removeFavoriteMutation.isPending,
  };
};
