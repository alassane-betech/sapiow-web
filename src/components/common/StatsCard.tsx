...
export const StatsCard: React.FC<StatsCardProps> = ({
  ...
  return (
    <div
      className={`bg-soft-ice-gray rounded-[20px] p-4 lg:p-6 shadow-sm border border-gray-100 ${className}`}
    >
      <h3 className="text-xs lg:text-xl font-medium text-cobalt-blue-500 mb-3">
        {title}
      </h3>
      <div className="flex items-start">
        <div className="text-[40px] lg:text-6xl font-bold text-cobalt-blue">
          {numericValue}
        </div>
        {currencySymbol && (
