  ...
  return (
    <div className={`space-y-2 ${className}`}>
      ...
      <div className="relative">
        ...
        {phoneInput.formattedValue && (
          <label className="absolute top-[5px] left-[120px] text-xs font-normal text-slate-gray bg-transparent px-1 transition-all duration-200 pointer-events-none z-10 font-sf-pro-rounded">
            Numéro de téléphone
          </label>
        )}
        ...
        <div className="flex">
          ...
          <div className="relative" ref={phoneInput.dropdownRef}>
            <button
              ...
              disabled={disabled}
              className={`flex items-center px-4 py-3 h-[56px] border rounded-[8px] mr-1 bg-white hover:bg-gray-50 focus:outline-none disabled:bg-gray-100 disabled:cursor-not-allowed transition-all cursor-pointer ${
          ...
          <input
            ...
            disabled={disabled}
            required={required}
            className={`flex-1 px-4 h-[56px] border rounded-[8px] focus:outline-none text-exford-blue font-medium placeholder-gray-500 text-base disabled:bg-gray-50 disabled:text-gray-500 transition-all font-sf-pro-rounded ${
